...
TEXTS: dict[str, dict[str, str | Callable[..., str]]] = {
    LANGUAGE_JA: {
        ...
        "settingsRestartPrompt": lambda: "設定を保存しました。サーバーを再起動しますか？",
        ...
        "settingsError_invalid_int": lambda field, **_: f"{field} には数値を入力してください",
        "settingsError_out_of_range": lambda field, min_value, max_value, **_: (
            f"{field} は {min_value}〜{max_value} の範囲で入力してください"
        ),
        "settingsError_invalid_choice": lambda field, **_: f"{field} の値が不正です",
        "settingsError_invalid_origin": lambda field, **_: f"{field} は http:// または https:// で始まるURLを指定してください",
        "settingsError_invalid_domain": lambda field, **_: f"{field} にはドメイン名（例: example.com）を指定してください",
    },
    LANGUAGE_EN: {
        ...
        "settingsRestartPrompt": lambda: "Settings saved. Restart the server now?",
        ...
        "settingsError_invalid_int": lambda field, **_: f"{field} must be a number",
        "settingsError_out_of_range": lambda field, min_value, max_value, **_: f"{field} must be between {min_value} and {max_value}",
        "settingsError_invalid_choice": lambda field, **_: f"Invalid value for {field}",
        "settingsError_invalid_origin": lambda field, **_: f"{field} must be a URL starting with http:// or https://",
        "settingsError_invalid_domain": lambda field, **_: f"{field} must be a domain name (e.g. example.com)",
    },
}
