...
export const en: Texts = {
  ...
  selectImageFile: "Select File",
  takePhoto: "Take Photo",
  cameraCaptureFailed: "Failed to capture from camera.",
  noImageSelected: "No image selected.",
  scanning: "Scanning...",
  importPosition: "Import Position",
  visionSideToMove: "Side to move",
  visionBoardViewpoint: "Board viewpoint",
  visionViewpointBlack: "Black side at bottom",
  visionViewpointWhite: "White side at bottom",
  ...
  undo: "Undo",
  redo: "Redo",
  clipboardOperationFailed: "Failed to access the clipboard.",
  ...
  pc: "PC",
  mobile: "Mobile",
  reloadRequiredToApplyUIMode: "Reload is required to apply UI mode.",
  ...
  defaultBookFormat: "New Book Format",
  ...
  arrowScoreDiffRange: "Arrow Score Difference Threshold",
  ...
  frontendBook: "Book (GUI Extension)",
  bookMoveSelection: "Book move selection",
  bookMoveSelectionUniform: "Uniform",
  bookMoveScoreTemperature: "Temperature (lower favors higher scores)",
  bookMaxMoves: "Book moves limit",
  bookMinEvalBlack: "Min evaluation (Black)",
  bookMinEvalWhite: "Min evaluation (White)",
  bookMaxEvalDiff: "Max eval difference",
  bookIgnoreRate: "Book ignore rate",
  bookDepthLimit: "Min book depth",
  unlimited: "Unlimited",
  noLimit: "No limit",
  invoke: "Invoke",
  ...
  recordAnalysisCompleted: "Record analysis completed.",
  ...
  strategy: "Strategy",
  strategyAigakari: "Double Wing Attack",
  strategyKakugawari: "Bishop Exchange",
  strategyYokofudori: "Side Pawn Capture",
  strategySankenbisha: "Third File Rook",
  strategyShikenbisha: "Fourth File Rook",
  strategyNakabisha: "Central Rook",
  strategyMukaibisha: "Opposing Rook",
  strategyAifuribisha: "Double Ranging Rook",
  strategyYagura: "Fortress",
  ...
  puzzles: "Puzzles",
  findBestMoveFor: (player: string) => `It's a puzzle. Find the best move for ${player}.`,
  evaluationPuzzle: "It's a puzzle. Please judge the evaluation of this position.",
  correct: "Correct!",
  ...
  puzzlesAvailable: (available: number, total: number) =>
    `Puzzles: ${available}/${total} available`,
  failedToLoadPuzzleManifest: "Failed to load puzzle manifest.",
  noPuzzlesFoundInManifest: "No puzzles found in manifest.",
  failedToLoadPuzzleFile: (file: string) => `Failed to load puzzle file: ${file}`,
  noPuzzlesCouldBeLoaded: "No puzzles could be loaded.",
  ...
  preview: "Preview",
  loadingKifu: "Loading kifu...",
  failedToLoadKifu: "Failed to load kifu.",
  matchedPositionNotFound: "The matched position could not be found.",
  firstMove: "Initial Position",
  ...
  noBookFoundCheckKifuDir:
    "No book found. Please check if KIFU_DIR is configured correctly and contains supported extensions (.db, .bin, .sbk).",
  hierarchy: "Hierarchy",
  list: "List",
