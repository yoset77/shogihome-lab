...
export const ja: Texts = {
  ...
  positionImage: "局面図",
  importBoardImage: "盤面画像スキャン",
  selectImageFile: "ファイル選択",
  takePhoto: "撮影",
  cameraCaptureFailed: "カメラの撮影に失敗しました。",
  noImageSelected: "画像が選択されていません。",
  scanning: "読み取り中...",
  importPosition: "スキャン",
  visionSideToMove: "手番",
  visionBoardViewpoint: "盤面の向き",
  visionViewpointBlack: "先手が手前",
  visionViewpointWhite: "後手が手前",
  ...
  undo: "元に戻す",
  redo: "やり直す",
  clipboardOperationFailed: "クリップボードへアクセスできませんでした。",
  ...
  pc: "PC",
  mobile: "モバイル",
  reloadRequiredToApplyUIMode: "UIモードの変更を反映するにはリロードが必要です。",
  ...
  enableVisionCameraAutoOpen: "スキャン時にカメラを自動起動",
  ...
  pv: "読み筋",
  analysisDB: "DB",
  analysisDBManager: "DBの管理",
  analysisDBExport: "エクスポート",
  cleanup: "クリーンアップ",
  recordCount: "件数",
  minDepth: "最小深さ",
  maxDepth: "最大深さ",
  ...
  bookMoveSelection: "定跡手の選択",
  bookMoveSelectionUniform: "均等",
  bookMoveScoreTemperature: "温度 (小さいほど高評価値を優先)",
  bookMaxMoves: "定跡利用手数",
  bookMinEvalBlack: "最小評価値（先手）",
  bookMinEvalWhite: "最小評価値（後手）",
  bookMaxEvalDiff: "最大評価値差",
  bookIgnoreRate: "定跡不使用率",
  bookDepthLimit: "最小定跡深さ",
  unlimited: "無制限",
  noLimit: "制限なし",
  invoke: "実行",
  ...
  resume: "再開",
  connecting: "接続中",
  connectionLostRetrying: "接続が切断されました。再接続中...",
  reconnected: "再接続しました。",
  copiedToClipboard: "クリップボードにコピーしました。",
  recordAnalysisCompleted: "棋譜解析が終了しました。",
  noHandicap: "平手",
  lanceHandicap: "香落ち",
  ...
  tournament: "棋戦",
  strategy: "戦型",
  strategyAigakari: "相掛かり",
  strategyKakugawari: "角換わり",
  strategyYokofudori: "横歩取り",
  strategySankenbisha: "三間飛車",
  strategyShikenbisha: "四間飛車",
  strategyNakabisha: "中飛車",
  strategyMukaibisha: "向かい飛車",
  strategyAifuribisha: "相振り飛車",
  strategyYagura: "矢倉",
  ...
  puzzles: "問題",
  findBestMoveFor: (player: string) => `問題です。${player}の好手を見つけてください。`,
  evaluationPuzzle: "問題です。この局面の形勢を判断してください。",
  correct: "正解です！",
  almostCorrect: "惜しい！",
  incorrect: "不正解...",
  referenceBestMove: "参考最善手",
  incorrectMovePleaseTryAgain: "不正解です。もう一度考えてみましょう。",
  evaluationThemes: ["優勢", "有利", "互角", "不利", "敗勢"],
  winRate: (rate: number) => `(勝率: ${rate}%)`,
  puzzlesAvailable: (available: number, total: number) => `問題: ${available}/${total} 問 利用可能`,
  failedToLoadPuzzleManifest: "問題集の目録の読み込みに失敗しました。",
  noPuzzlesFoundInManifest: "問題集の目録に問題が見つかりませんでした。",
  failedToLoadPuzzleFile: (file: string) => `問題ファイルの読み込みに失敗しました: ${file}`,
  noPuzzlesCouldBeLoaded: "読み込める問題がありませんでした。",
  ...
  serverKifu: "サーバー棋譜",
  preview: "プレビュー",
  loadingKifu: "棋譜を読み込み中...",
  failedToLoadKifu: "棋譜の読み込みに失敗しました。",
  matchedPositionNotFound: "検索時の一致局面が見つかりませんでした。",
  firstMove: "開始局面",
  previousMove: "一手戻る",
  nextMove: "一手進む",
  finalPosition: "最終局面",
  ...
  showSearchLogOnMobile: "思考タブを表示",
  evaluationChartType: "グラフの表示形式",
  noBookFoundCheckKifuDir:
    "定跡ファイルが見つかりませんでした。KIFU_DIR が設定されているか、対象の拡張子（.db, .bin, .sbk）が含まれているか確認してください。",
  hierarchy: "階層",
  list: "一覧",
  kifuSearch: "棋譜検索",
