...
export const zh_tw: Texts = {
  ...
  undo: "復原",
  redo: "重做",
  clipboardOperationFailed: "無法存取剪貼簿。",
  ...
  pc: "PC",
  mobile: "行動裝置",
  reloadRequiredToApplyUIMode: "需要重新載入以套用UI模式。",
  ...
  lastMove: "直前的指し手",
  nextMoves: "以降の指し手",
  goToThisPosition: "移動到此局面",
  noDuplicatePositions: "未找到其他同一局面。",
  nDuplicatePositionsFound: (n: number) => `找到了 ${n} 處同一局面。`,
  ...
  onlySFEN: "只有 SFEN",
  pasteDialog: "貼上視窗",
  liveDuplicatePositionDetection: "實時同一局面檢測",
  onTheFlyThreshold: "On-the-fly 模式閾值",
  defaultBookFormat: "新定跡檔的儲存格式",
  usiProtocol: "USI協定",
  ...
  branches: "分支",
  branchListMode: "分支列表模式",
  previousMoveBranches: "上一步的分支",
  nextMoveBranches: "下一步的分支",
  bookmark: "書籤",
  bookmarkList: "書籤一覽",
  ...
  bookMoveSelection: "定跡著手選擇",
  bookMoveSelectionUniform: "均等",
  bookMoveScoreTemperature: "溫度（越低越偏好高評價值）",
  bookMaxMoves: "定著手数限制",
  bookMinEvalBlack: "最小評估值（先手）",
  bookMinEvalWhite: "最小評估值（後手）",
  bookMaxEvalDiff: "最大評估值差",
  bookIgnoreRate: "忽略定著機率",
  bookDepthLimit: "最小定跡深度",
  unlimited: "無限制",
  noLimit: "無限制",
  invoke: "執行",
  ...
  resume: "重新開始",
  connecting: "連線中...",
  connectionLostRetrying: "連線中斷。正在重新連線...",
  reconnected: "已重新連線。",
  copiedToClipboard: "已複製到剪貼簿。",
  recordAnalysisCompleted: "棋譜分析已完成。",
  noHandicap: "平手",
  lanceHandicap: "香落",
  ...
  strategy: "戰型",
  strategyAigakari: "相掛",
  strategyKakugawari: "角交換",
  strategyYokofudori: "橫步取",
  strategySankenbisha: "三間飛車",
  strategyShikenbisha: "四間飛車",
  strategyNakabisha: "中飛車",
  strategyMukaibisha: "向飛車",
  strategyAifuribisha: "相振飛車",
  strategyYagura: "矢倉",
  ...
  puzzles: "問題",
  findBestMoveFor: (player: string) => `問題來了。請找出 ${player} 的最佳著手。`,
  evaluationPuzzle: "局面判斷問題。請選擇正確的形勢評估。",
  correct: "正確！",
  almostCorrect: "很接近！",
  incorrect: "不正確...",
  referenceBestMove: "參考最善手",
  incorrectMovePleaseTryAgain: "錯誤，請再試一次。",
  evaluationThemes: ["優勢", "有利", "互角", "不利", "敗勢"],
  winRate: (rate: number) => ` (此局面的勝率: ${rate}%)`,
  puzzlesAvailable: (available: number, total: number) => `問題: ${available}/${total} 可用`,
  failedToLoadPuzzleManifest: "無法載入問題清單。",
  noPuzzlesFoundInManifest: "問題清單中沒有找到問題。",
  failedToLoadPuzzleFile: (file: string) => `無法載入問題檔案: ${file}`,
  noPuzzlesCouldBeLoaded: "無法載入任何問題。",
  ...
  preview: "預覽",
  loadingKifu: "正在載入棋譜...",
  failedToLoadKifu: "棋譜載入失敗。",
  matchedPositionNotFound: "找不到搜尋時符合的局面。",
  firstMove: "初始局面",
  previousMove: "上一步",
  nextMove: "下一步",
  finalPosition: "最終局面",
  ...
  saveToServer: "儲存至伺服器",
  upload: "上傳",
  uploadDestination: "上傳位置",
  uploadFileName: "儲存名稱",
  rootDirectory: "根目錄",
  createNewFolder: "建立新資料夾",
  folderName: "資料夾名稱",
  invalidServerEntryName: (name: string) => `名稱無效。請檢查字元與長度。\n${name}`,
  selectFiles: "選擇檔案",
  nFilesUploaded: (n: number) => `已上傳 ${n} 個檔案。`,
  overwriteUploadConflicts: (names: string) => `已有同名檔案。是否覆寫？\n${names}`,
  duplicateUploadFileNames: (names: string) => `儲存名稱不可重複。請重新命名同名檔案。\n${names}`,
  unsupportedUploadFiles: (names: string) => `不支援的檔案格式。\n${names}`,
  search: "搜尋",
  ...
  noBookFoundCheckKifuDir:
    "未找到定跡檔案。請檢查 KIFU_DIR 是否正確配置，且包含支援的副檔名（.db, .bin, .sbk）。",
  hierarchy: "階層",
  list: "列表",
  kifuSearch: "棋譜搜尋",
