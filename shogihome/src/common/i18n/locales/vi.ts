...
export const vi: Texts = {
  ...
  undo: "Hoàn tác",
  redo: "Làm lại",
  clipboardOperationFailed: "Không thể truy cập bảng nhớ tạm.",
  ...
  pc: "PC",
  mobile: "Di động",
  reloadRequiredToApplyUIMode: "Cần tải lại để áp dụng chế độ giao diện.",
  ...
  via: "qua",
  lastMove: "Nước đi trước đó",
  nextMoves: "Các nước đi tiếp theo",
  goToThisPosition: "Đi đến thế cờ này",
  noDuplicatePositions: "Không tìm thấy thế cờ nào khác giống nhau.",
  nDuplicatePositionsFound: (n: number) => `Đã tìm thấy ${n} thế cờ giống nhau.`,
  appearanceCount: "Số lần xuất hiện",
  ...
  liveDuplicatePositionDetection: "Phát hiện thế cờ giống nhau theo thời gian thực",
  onTheFlyThreshold: "Ngưỡng mở dưới dạng on-the-fly",
  defaultBookFormat: "Định dạng lưu book mới",
  ...
  pv: "PV",
  analysisDB: "DB",
  analysisDBManager: "Analysis DB Management",
  analysisDBExport: "Export",
  cleanup: "Cleanup",
  recordCount: "Count",
  minDepth: "Min Depth",
  maxDepth: "Max Depth",
  ...
  frontendBook: "Sách (Mở rộng GUI)",
  bookMoveSelection: "Chọn nước đi trong sách",
  bookMoveSelectionUniform: "Đồng đều",
  bookMoveScoreTemperature: "Nhiệt độ (thấp hơn ưu tiên đánh giá cao)",
  bookMaxMoves: "Giới hạn nước đi sách",
  bookMinEvalBlack: "Đánh giá tối thiểu (Tiên thủ)",
  bookMinEvalWhite: "Đánh giá tối thiểu (Hậu thủ)",
  bookMaxEvalDiff: "Chênh lệch đánh giá tối đa",
  bookIgnoreRate: "Tỷ lệ bỏ qua sách",
  bookDepthLimit: "Độ sâu sách tối thiểu",
  ...
  connectionLostRetrying: "Mất kết nối. Đang thử kết nối lại...",
  reconnected: "Đã kết nối lại.",
  copiedToClipboard: "Đã sao chép vào bảng nhớ tạm.",
  recordAnalysisCompleted: "Đã phân tích kỳ phổ xong.",
  ...
  tournament: "Giải đấu",
  strategy: "Chiến pháp",
  strategyAigakari: "Aigakari",
  strategyKakugawari: "Đổi tượng",
  strategyYokofudori: "Ăn tốt biên",
  strategySankenbisha: "Xe cột ba",
  strategyShikenbisha: "Xe cột bốn",
  strategyNakabisha: "Xe trung tâm",
  strategyMukaibisha: "Xe đối đầu",
  strategyAifuribisha: "Song xe dao động",
  strategyYagura: "Yagura",
  ...
  exceptGames: "Ngoại trừ lúc chơi",
  ...
  puzzles: "Câu đố",
  findBestMoveFor: (player: string) => `Đây là một câu đố. Tìm nước đi tốt nhất cho ${player}.`,
  evaluationPuzzle: "Đây là câu đố đánh giá thế cờ. Hãy chọn đánh giá đúng.",
  correct: "Chính xác!",
  almostCorrect: "Gần đúng!",
  incorrect: "Sai rồi...",
  referenceBestMove: "Nước đi tốt nhất tham khảo",
  incorrectMovePleaseTryAgain: "Không chính xác. Hãy thử lại.",
  evaluationThemes: ["Thắng thế", "Ưu thế", "Cân bằng", "Kém thế", "Thua thế"],
  winRate: (rate: number) => ` (Tỷ lệ thắng cho thế cờ này: ${rate}%)`,
  puzzlesAvailable: (available: number, total: number) => `Câu đố: ${available}/${total} có sẵn`,
  failedToLoadPuzzleManifest: "Không thể tải danh sách câu đố.",
  noPuzzlesFoundInManifest: "Không tìm thấy câu đố nào trong danh sách.",
  failedToLoadPuzzleFile: (file: string) => `Không thể tải tệp câu đố: ${file}`,
  noPuzzlesCouldBeLoaded: "Không thể tải bất kỳ câu đố nào.",
  ...
  preview: "Xem trước",
  loadingKifu: "Đang tải kỳ phổ...",
  failedToLoadKifu: "Tải kỳ phổ thất bại.",
  matchedPositionNotFound: "Không tìm thấy thế cờ khớp với tìm kiếm.",
  firstMove: "Thế cờ ban đầu",
  previousMove: "Nước trước",
  nextMove: "Nước tiếp theo",
  finalPosition: "Thế cờ cuối",
  ...
  showSearchLogOnMobile: "Hiện thẻ lịch sử suy nghĩ",
  evaluationChartType: "Loại biểu đồ đánh giá",
  noBookFoundCheckKifuDir:
    "Không tìm thấy tệp định thức. Vui lòng kiểm tra cấu hình KIFU_DIR và đảm bảo có các định dạng hỗ trợ (.db, .bin, .sbk).",
