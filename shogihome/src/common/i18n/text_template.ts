export type Texts = {
  ...
  visionSideToMove: string;
  visionBoardViewpoint: string;
  visionViewpointBlack: string;
  visionViewpointWhite: string;
  ...
  tournament: string;
  strategy: string;
  strategyAigakari: string;
  strategyKakugawari: string;
  strategyYokofudori: string;
  strategySankenbisha: string;
  strategyShikenbisha: string;
  strategyNakabisha: string;
  strategyMukaibisha: string;
  strategyAifuribisha: string;
  strategyYagura: string;
  ...
  noPuzzlesFoundInManifest: string;
  failedToLoadPuzzleFile: (file: string) => string;
  noPuzzlesCouldBeLoaded: string;
  ...
  showingFirstKifu: (n: number) => string;
  exportSearchResultsAsSfen: string;
  convertingToSfen: string;
  saveDestination: string;
  maximumMoves: string;
  leaveBlankForUnlimited: string;
  standardInitialPositionOnly: string;
  exportingKifuProgress: (processed: number, total: number) => string;
  nSfenLinesExported: (n: number) => string;
  maximumMovesMustBePositive: string;
  sfenExportCompleted: (path: string) => string;
  sfenExportCompletedWithWarnings: (failedFiles: number) => string;
  sfenExportFailed: string;
  sfenExportJobNotFound: string;
  player1: string;
  player2: string;
